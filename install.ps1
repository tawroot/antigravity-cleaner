...
$GithubBaseUrl = "https://github.com/tawroot/antigravity-cleaner/releases/latest/download"
...
Write-Host "  ⚡ Antigravity Cleaner Toolkit Installer (v5.2.0)" -ForegroundColor Yellow
