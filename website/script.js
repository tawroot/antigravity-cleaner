...
const translations = {
    ...
    fa: {
        ...
        how_it_works_subtitle: "معماری خودترمیم‌شونده: از پاکسازی عمیق کش و پچ هسته Go تا اتصال بدون دردسر پروکسی.",
        step1_title: "۰۱. پاکسازی جراحی کش‌های معیوب و قفل‌های سنگین",
        step1_desc: "حذف کش‌های سنگین و آسیب‌دیده GPU/Dawn، قفل‌های معلق حافظه (SingletonLock) و شمارنده‌های ارور ۴۲۹ بدون دستکاری یا پاک شدن لاگین اکانت گوگل و کوکی‌ها.",
        step2_title: "۰۲. پچ مستقیم هسته باینری Go و ماژول‌های کلاینت",
        step2_desc: "پچ عمیق هسته باینری Go (دیمن agy)، باندل main.js و افزونه ادیتور برای خنثی‌سازی چک‌های ریجن‌لاک و قطع درخواست‌های پنهان تله‌متری که پهنای باند را هدر می‌دادند.",
        step3_title: "۰۳. اتصال سبک لایه ۷ و پایداری استریم روی اینترنت ضعیف",
        step3_desc: "حذف بار سنگین و افت پینگ ناشی از TUN و هدایت اختصاصی ادیتور با پروکسی محلی؛ هارت‌بیت ۱۵ ثانیه‌ای مانع قطع شدن استریم مدل‌ها حتی روی اینترنت‌های ضعیف و بی‌کیفیت می‌شود.",
        perf_banner_title: "به‌طور ملموس سبک‌تر و روان‌تر روی اینترنت‌های ضعیف و محدود",
        perf_banner_desc: "با حذف سربار مجازی‌سازی کارت شبکه TUN، قطع درخواست‌های تله‌متری سنگین در پس‌زمینه و فعال‌سازی هارت‌بیت ۱۵ ثانیه‌ای، محیط برنامه‌نویسی منابع بسیار کمتری از سیستم و شبکه مصرف می‌کند و حتی با پینگ بالا یا افت سرعت، بدون هنگ و قطعی به کار خود ادامه می‌دهد."
    },
    ru: {
