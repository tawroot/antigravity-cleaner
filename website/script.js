...
const translations = {
    ...
    fa: {
        ...
        coming_soon: "به‌زودی",
        how_it_works_badge: "⚡ در ۳ مرحله ساده چطوری کار می‌کنه؟",
        how_it_works_title: "رفع تمام خطاهای آنتی‌گرویتی زیر ۳۰ ثانیه",
        how_it_works_subtitle: "از پاکسازی کش‌های اضافه و دور زدن تحریم تا اتصال روان به پروکسی؛ بدون اینکه اکانت گوگلت بپره.",
        step1_title: "۱. پاکسازی کش و فایل‌های خراب (اکانتت سر جاشه)",
        step1_desc: "کش‌های سنگین، فایل‌های قفل‌شده و محدودیت ارور ۴۲۹ رو کامل پاک می‌کنه؛ بدون اینکه نیاز باشه دوباره توی گوگل لاگین کنی یا پروژه‌هات دست بخورن.",
        step2_title: "۲. دور زدن تحریم از ریشه (پچ فایل‌های برنامه)",
        step2_desc: "کدهای مسدودکننده گوگل رو توی فایل‌های اصلی و هسته Antigravity غیرفعال می‌کنه تا برنامه دیگه به لوکیشن گیر نده و الکی از اینترنتت مصرف نکنه.",
        step3_title: "۳. اتصال روان و بدون قطعی (حتی با نت ضعیف)",
        step3_desc: "نیازی به روشن کردن TUN مود سنگین نیست؛ فقط خود برنامه به فیلترشکن وصل میشه و قابلیت ضد قطعی هوشمند نمی‌ذاره وسط کدنویسی استپ کنه.",
        perf_banner_title: "چرا برنامه تا ۲ برابر سبک‌تر و روان‌تر کار می‌کنه؟",
        perf_banner_desc: "چون کل اینترنت سیستمت درگیر فیلترشکن نمیشه و پینگت بالا نمیره، گزارش‌های مخفی پس‌زمینه قطع شده، و اتصال به هوش مصنوعی با هارت‌بیت زنده می‌مونه؛ حتی اگه نتت پینگ بالا یا نوسان داشته باشه."
    },
    ru: {
